...
3. Run the script from your terminal: python astro_numerology_analysis.py
"""
import sys
import random
import pandas as pd
...
# ---------------------------
# NEW Toss Prediction Logic
# ---------------------------

def predict_toss_numerology(a_name, b_name, numerology_a, numerology_b):
    """
    Toss Method 1: Numerology compatibility between Captain's numbers and the Match Date.
    """
...
def predict_toss_horary(a_name, b_name, a_bno, b_bno, match_date):
    """
    Toss Method 2: Day Ruler's Number Advantage.
...
def predict_toss_star_lord(a_name, b_name, a_bno, b_bno, moon_info):
    """
    Toss Method 3: Nakshatra Lord (Star Lord) Numerology.
...
def main():
    ...
    for index, row in df_input.iterrows():
        ...
        try:
            ...
            # Match trend score (Main prediction logic)
    ...
    if all_results:
        ...
        print("The file now contains 19 new analytical columns.")
    else:

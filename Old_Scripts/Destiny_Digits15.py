...
print("\nPlayer 1      Player 2           Win/Loss              Final Numbers")
...
print("\n                                                    Final Number 1:", final_number1, f"({', '.join(map(str, triplet1))})")
print("                                                    Final Number 2:", final_number2, f"({', '.join(map(str, triplet2))})")
print("                                                    Final Breakdown:", final_breakdown, "/", highest_last_digit)

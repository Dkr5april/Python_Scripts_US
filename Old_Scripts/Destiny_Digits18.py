...
print("Debug: Inputs received correctly!")
...
print("Debug: Sum calculations completed!")
...
print(f"Debug: Column reductions done!\nP1: {p1_col1}, {p1_col2}\nP2: {p2_col1}, {p2_col2}\nMatch: {match_col1}, {match_col2}")
...
print(f"Debug: Combined matrices reductions computed!\nC1: {c1_col1}, {c1_col2}\nC2: {c2_col1}, {c2_col2}")

# Final reduction
final_number1 = reduce_to_single_digit(c1_col1 + c1_col2)
final_number2 = reduce_to_single_digit(c2_col1 + c2_col2)

print(f"Debug: Final numbers calculated! {final_number1}, {final_number2}")
...
print(f"Debug: Triplets computed! Triplet1: {triplet1}, Triplet2: {triplet2}")
...
while reduce_to_single_digit(1 + 9 + X) != highest_last_digit:
    ...
    if attempts > max_attempts:
        print("Loop exceeded safe limit. Exiting.")
        break

final_breakdown = f"1,9,{X}"
print(f"Debug: Final breakdown computed: {final_breakdown}")
...
print(f"Debug: Win/Loss matrix computed! {win_loss_matrix}")

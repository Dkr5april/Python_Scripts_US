...
doubling_dict = {
    1: "1,1,5", 2: "8,8,4", 3: "3,3,6", 4: "2,2,8", 5: "7,7,5",
    6: "6,6,3", 7: "1,1,5", 8: "4,4,2", 9: "9,9,9"
}

doubling_result1 = doubling_dict.get(final_number1, "N/A")
doubling_result2 = doubling_dict.get(final_number2, "N/A")

# Apply 1,9 logic based on the highest last digit
highest_last_digit = max(int(doubling_result1[-1]), int(doubling_result2[-1]))

# Compute correct third digit for final breakdown
third_digit = reduce_to_single_digit(1 + 9 + highest_last_digit)
final_breakdown = f"1,9,{third_digit}"
...
print("\nFinal Numbers:")
print(f"Final Number 1: {final_number1} ({doubling_result1})")
print(f"Final Number 2: {final_number2} ({doubling_result2})")

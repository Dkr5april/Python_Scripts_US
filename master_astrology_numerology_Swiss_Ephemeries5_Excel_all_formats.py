...
def main():
    ...
    for index, row in df_input.iterrows():
        ...
        try:
            ...
            # Convert to uppercase and normalize spaces/hyphens
            match_format = str(row.get('Match_Format', 'T20')).upper().replace(" ", "-").replace("-", "") 
            ...
            if match_format == 'TEST':
                ...
                # Ensure 100BALL is mapped correctly
                if match_format == '100BALL':
    ...
    if all_results:
        ...
        print("The file now calculates Day Power based on the full 5-day period for TEST matches.")
    else:

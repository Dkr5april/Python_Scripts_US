...
THRESHOLD = 150 # Lowered to 150 for better sensitivity to soft/silent speech
...
class LevelUpCopilot:
            ...
            try:
                ...
                while self.is_running:
                    ...
                    if self.mode == target_mode:
                        ...
                        if vol > THRESHOLD:
                            processed = np_data[::2][::3] # Resample to 16k mono
    ...
    def cloud_engine(self):
        while self.is_running:
            try:
                ...
                # Optimized for Indian English and natural formatting
                self.dg_conn.start(LiveOptions(
                    model="nova-2", 
                    language="en-IN", 
                    smart_format=True,
                    encoding="linear16", 
    ...
    def context_engine(self):
        while self.is_running:
            time.sleep(0.5)
            # 3.0 second pause threshold to handle "break voice"
    ...
    def ask_ai(self, text):
        try:
            ...
            # Robust split logic using regex for Level tags
            ...
            # Display result with latency info
    ...
    def next_level(self):
        ...
        if lvl_str in self.full_response:
            ...
            self.log(f"Level {lvl_str} not available in response.")

...
class UniversalCopilot:
    def __init__(self):
        ...
        self.label = tk.Label(
            self.root, text="System Ready - Play Video...",
    ...
    def run_audio_loop(self):
        while True: # Auto-restart if connection drops
            try:
                ...
                def on_message(self_dg, result, **kwargs):
                    ...
                    if transcript:
                        ...
                        # If the speaker pauses (is_final), ask the AI
                ...
                # Nova-2 with standard 16khz settings
                ...
                self.root.after(0, lambda: self.label.config(text="Listening Successfully...", fg="#00FF00"))
                ...
                while True:
                    ...
                    dg_connection.send(resampled.tobytes())

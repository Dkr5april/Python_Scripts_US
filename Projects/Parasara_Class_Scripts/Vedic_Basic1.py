...
os.system('chcp 65001 > nul')  # UTF-8 code page ని ఫోర్స్ చేస్తుంది
...
def get_machine_id():
    # UUID ఆధారంగా ఒక సింపుల్ 5-డిజిట్ నంబర్‌ను జనరేట్ చేస్తుంది
...
# --- లైసెన్స్ రన్ టైమ్ చెకింగ్ ఎగ్జిక్యూషన్ ---
...
if not is_activated:
    ...
    if current_uses >= MAX_FREE_USES:
        ...
        print("👤 Admin Name   : Koteswara Davuluri")
        print("💬 WhatsApp     : [మీ ఫోన్ నంబర్ ఇక్కడ ఇవ్వండి]")
        print("="*75 + "\n")
...
if sys.platform == "win32":
    ...
    os.system("cls")  # 👈 విండోస్ బగ్స్/లైన్లను క్లియర్ చేసే ఫిక్స్

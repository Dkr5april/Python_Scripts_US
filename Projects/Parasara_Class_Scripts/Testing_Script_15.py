...
class AstroEngine:
    ...
    def get_artistic_synthesis(self):
        ...
        for p_name, v in self.n_sid.items():
            ...
            # ఇష్ట-కష్ట ఫలాల పాయింట్లను (Virupas) రూపాల్లోకి మారుస్తున్నాము (1 Rupa = 60 Points)
            ...
            # --- 4. PREDICTIVE SYNTHESIS WITH EXACT RUPAS ---
            ...
            # SPECIAL SCENARIO: SHANI TRANSIT ACTIVE ON LAGNA

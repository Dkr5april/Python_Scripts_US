...
class AstroApp:
    ...
    def __init__(self, root):
        ...
        self.t_dob = ttk.Entry(t_frame, width=12, takefocus=0); self.t_dob.insert(0, datetime.now().strftime("%d/%m/%Y")); self.t_dob.grid(row=0, column=0)
        self.t_tob = ttk.Entry(t_frame, width=10, takefocus=0); self.t_tob.insert(0, datetime.now().strftime("%H:%M")); self.t_tob.grid(row=0, column=1)
    ...
    def update_transit_only(self):
        ...
        try:
            ...
            print("Invalid Date/Time format in Transit Control")

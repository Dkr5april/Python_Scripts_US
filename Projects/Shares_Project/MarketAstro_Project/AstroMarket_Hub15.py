...
# Parse underlying chains out of evaluate_market_rules execution scope for Section 9 safely
X = data["Mo"]["lord"]
...
# ==========================================================
# 8. DEEP CONTAINER PARSING FOR KP RULES (FIXED FOR Y-CHAINS)
# ==========================================================
rules_rows = ""
...
# Loop through rule dictionaries processing prefixes sequentially
for key, value in logic.items():
    key_text = str(key)
    key_upper = key_text.upper()

    if key_upper.startswith(("R1", "R2", "R3", "R4", "R5")) or "CHAIN" in key_upper or key_upper.startswith(("X", "Y")):
